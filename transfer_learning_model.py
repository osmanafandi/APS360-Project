...
class ANNClassifier(nn.Module):
    def __init__(self):
        ...
        self.name = "ANN"
        self.layer1 = nn.Linear(7 * 512 * 7, 84) #images are rgb 224 x 224 pixels
    ...
    def forward(self, img):
        ...
        return output
#problem might be here - number of channels
...
if torch.cuda.is_available():
    VGGC.cuda()
    model_2.cuda() #USE GPU!

torch.cuda.memory_summary(device=None, abbreviated=False)
train(model_2, train_data, val_data, 0.0005, 32, 15)